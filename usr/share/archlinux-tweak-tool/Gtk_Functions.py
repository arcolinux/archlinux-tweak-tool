    ...
    if os.path.isfile(fn.gtk3_settings):
        try:
            ...
            with open(fn.gtk3_settings, "r", encoding="utf-8") as f:
                lines = f.readlines()
                f.close()
            pos = int(fn.gtk_get_position(lines, "gtk-theme-name"))
    ...
    if os.path.isfile(fn.gtk3_settings):
        try:
            ...
            with open(fn.gtk3_settings, "r", encoding="utf-8") as f:
                lines = f.readlines()
                f.close()
            pos = int(fn.gtk_get_position(lines, "gtk-icon-theme-name"))
            output = lines[pos].split("=")
    ...
    if os.path.isfile(fn.gtk3_settings):
        try:
            ...
            with open(fn.gtk3_settings, "r", encoding="utf-8") as f:
                lines = f.readlines()
                f.close()
            pos = int(fn.gtk_get_position(lines, "gtk-cursor-theme-name"))
            output = lines[pos].split("=")
    ...
    if os.path.isfile(fn.gtk3_settings):
        ...
        try:
            with open(fn.gtk3_settings, "r", encoding="utf-8") as f:
                lines = f.readlines()
                f.close()
            pos = int(fn.gtk_get_position(lines, item))
            output = lines[pos].split("=")
    ...
    if os.path.isfile(fn.gtk2_settings):
        ...
        try:
            ...
            if not data:
                ...
                pos = int(fn._get_position(lines, item))
