...
def GUI(self, Gtk, vboxStack7, termite, GdkPixbuf, base_dir):
   ...
   btn_remove_alacritty_themes.connect("clicked", self.on_clicked_remove_alacritty_themes)
   ...
   btn_install_xfce4_terminal.connect("clicked", self.on_clicked_install_xfce4_terminal)
   ...
   btn_install_termite_themes.connect("clicked", self.on_clicked_install_termite_themes)
