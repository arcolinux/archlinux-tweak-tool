...
We obey the dependencies of pacman"
    ...
    flowbox.add(self.ayu_theme)
    flowbox.add(self.breeze)
    flowbox.add(self.dracula_gtk_theme)
    flowbox.add(self.fluent_gtk_theme)
    flowbox.add(self.fluent_kde_theme_git)
    flowbox.add(self.graphite_gtk_theme_git)
    flowbox.add(self.kripton_theme_git)
    flowbox.add(self.kvantum_theme_materia)
    flowbox.add(self.kvantum_theme_qogir_git)
    flowbox.add(self.layan_gtk_theme_git)
    flowbox.add(self.layan_kde_git)
    flowbox.add(self.materia_gtk_theme)
    flowbox.add(self.materia_kde)
    flowbox.add(self.numix_gtk_theme_git)
    flowbox.add(self.openbox_themes_pambudi_git)
    flowbox.add(self.orchis_kde_theme_git)
    flowbox.add(self.orchis_theme_git)
    flowbox.add(self.qogir_gtk_theme_git)
    flowbox.add(self.sweet_theme_git)
    flowbox.add(self.sweet_gtk_theme_dark)

    hbox12.pack_start(flowbox, True, True, 10)
...
We obey the dependencies of pacman"
    ...
    flowbox.add(self.flat_remix_git)
    flowbox.add(self.fluent_icon_theme_git)
    flowbox.add(self.halo_icons_git)
    flowbox.add(self.la_capitaine_icon_theme_git)
    flowbox.add(self.luna_icon_theme_git)
    flowbox.add(self.moka_icon_theme_git)
    flowbox.add(self.nordzy_icon_theme_git)
    flowbox.add(self.numix_circle_arc_icons_git)
    flowbox.add(self.numix_circle_icon_theme_git)
    flowbox.add(self.obsidian_icon_theme)
    flowbox.add(self.oranchelo_icon_theme_git)
    flowbox.add(self.paper_icon_theme)
    flowbox.add(self.papirus_folders_git)
    flowbox.add(self.papirus_folders_gui_bin)
    flowbox.add(self.papirus_folders_nordic)
    ...
    flowbox.add(self.whitesur_icon_theme_git)
    flowbox.add(self.zafiro_icon_theme)
...
We obey the dependencies of pacman"
    ...
    flowbox.add(self.bibata_cursor_theme_bin)
    flowbox.add(self.bibata_cursor_translucent)
    flowbox.add(self.bibata_extra_cursor_theme)
    flowbox.add(self.bibata_rainbow_cursor_theme)
    flowbox.add(self.capitaine_cursors)
    flowbox.add(self.catppuccin_cursors_git)
    flowbox.add(self.dracula_cursors_git)
    flowbox.add(self.layan_cursor_theme_git)
    flowbox.add(self.oxy_neon)
    flowbox.add(self.sweet_cursor_theme_git)
    flowbox.add(self.vimix_cursors)
    flowbox.add(self.xcursor_arch_cursor_complete)
    flowbox.add(self.xcursor_breeze)
    flowbox.add(self.xcursor_comix)
    flowbox.add(self.xcursor_flatbed)
    flowbox.add(self.xcursor_neutral)
    flowbox.add(self.xcursor_premium)
    flowbox.add(self.xcursor_simpleandsoft)
    ...
    label13.set_text("Choose what to select with a button")
    btn_all_selection = Gtk.Button(label="All")
    btn_all_selection.connect("clicked", self.on_click_cursor_theming_all_selection)
    btn_normal_selection = Gtk.Button(label="Normal")
    ...
    btn_none_selection = Gtk.Button(label="None")
    btn_none_selection.connect("clicked", self.on_click_cursor_theming_none_selection)
...
We obey the dependencies of pacman"
    ...
    flowbox.add(self.ttf_nerd_fonts_symbols)
    ...
    label13.set_text("Choose what to select with a button")
    btn_all_selection = Gtk.Button(label="All")
    btn_all_selection.connect("clicked", self.on_click_font_theming_all_selection)
    btn_normal_selection = Gtk.Button(label="Normal")
    btn_normal_selection.connect("clicked", self.on_click_font_theming_normal_selection)
    btn_small_selection = Gtk.Button(label="Minimal")
    btn_small_selection.connect("clicked", self.on_click_font_theming_minimal_selection)
    btn_none_selection = Gtk.Button(label="None")
    btn_none_selection.connect("clicked", self.on_click_font_theming_none_selection)
    hbox42.pack_start(label13, False, False, 10)
    hbox42.pack_end(btn_none_selection, False, False, 10)
    hbox42.pack_end(btn_small_selection, False, False, 10)
    hbox42.pack_end(btn_normal_selection, False, False, 10)
